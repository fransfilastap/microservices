...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(Twitter2KafkaServiceConfig twitter2KafkaServiceConfig, TwitterKafkaStatusListener twitterKafkaStatusListener) {
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, TwitterException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitter2KafkaServiceConfig.getTwitterV2BaseUrl());
            ...
            while (line != null){
                ...
                if(!line.isEmpty()){
                    ...
                    try{
                        ...
                        LOGGER.error("Could not create status for text: {}",ex);
                    }
    ...
    private String getFormattedString(String string, Map<String,String> rules){
        ...
        if(rules.size()==1){
            ...
            for (Map.Entry<String,String> entry: rules.entrySet()){
                ...
                stringBuilder.append("{\"value\":\""+value+"\",\"tag\":\""+rules.get(tag)+"\"}");
            }
    ...
    private String getFormattedTweet(String line) {
        JSONObject jsonData = (JSONObject) new JSONObject(line).get("data");
