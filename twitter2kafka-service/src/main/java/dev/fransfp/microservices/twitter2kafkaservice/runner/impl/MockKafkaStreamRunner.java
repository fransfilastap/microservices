...
import dev.fransfp.microservices.twitter2kafkaservice.exception.Twitter2KafkaServiceException;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    public MockKafkaStreamRunner(Twitter2KafkaServiceConfig twitter2KafkaServiceConfig, TwitterKafkaStatusListener twitterKafkaStatusListener) {
    ...
    public void start() throws TwitterException {
        ...
        int minTweetLength = twitter2KafkaServiceConfig.getMockMinTweetLength();
        int maxTweetLength = twitter2KafkaServiceConfig.getMockMaxTweetLength();
        long sleepTimeMs = twitter2KafkaServiceConfig.getMockSleepMs();
    ...
    private void sleep(long sleepTimeMs){
        try {
            ...
            throw new Twitter2KafkaServiceException("Error while sleeping for waiting new status to create.",e);
        }
    }
